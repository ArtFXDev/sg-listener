...
channel.queue_declare(queue=SG_WORKER_QUEUE_NAME, durable=True)
channel.queue_bind(exchange=BROKER_EXCHANGE_NAME, queue=SG_WORKER_QUEUE_NAME, routing_key="#")
channel.basic_qos(prefetch_count=20)
channel.basic_consume(queue=SG_WORKER_QUEUE_NAME, on_message_callback=digest_event)
